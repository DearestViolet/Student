...
//    public Event createSeries(String name, ArrayList<String> tag, LocalDateTime start, LocalDateTime end,
//                              Frequency frequency, int numOccurrences) {
//        Event eventSeries = new Event(name);
